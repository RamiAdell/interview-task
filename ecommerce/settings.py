...
SECRET_KEY = 'django-insecure-9pyrfieazy20rv$7q@g@mpr05rif-_gp5ze1xqbj9+k!0(=z$&'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Multi-tenant e-commerce platform API with products, orders, and company management',
    'VERSION': '1.0.0',
